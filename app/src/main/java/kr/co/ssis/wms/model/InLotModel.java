...
public class InLotModel extends ResultModel {
    List<InLotModel.Item>items;
    ...
    public class Item extends ResultModel{
        ...
        public int getBro_no1() {
            return bro_no1;
        }

        public void setBro_no1(int bro_no1) {
            this.bro_no1 = bro_no1;
        }

        public int getBro_no2() {
            return bro_no2;
        }

        public void setBro_no2(int bro_no2) {
            this.bro_no2 = bro_no2;
        }
