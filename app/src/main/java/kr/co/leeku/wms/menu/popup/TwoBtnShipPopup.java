...
public class TwoBtnShipPopup {
    Activity mActivity;

    Dialog dialog;
    Handler mHandler;

    public TwoBtnShipPopup(Activity activity, String message, int title, Handler handler){
        mActivity = activity;
        mHandler = handler;
    ...
    private void showPopUpDialog(Activity activity, String message, int title){
        ...
        dialog.setContentView(R.layout.popup_ship_message);
