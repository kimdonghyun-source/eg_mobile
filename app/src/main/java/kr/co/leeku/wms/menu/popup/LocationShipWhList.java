...
public class LocationShipWhList {
    //출고처 팝업

    Activity mActivity;

    Dialog dialog;
    List<ShipWhListModel.Item> mWhModel;
    Handler mHandler;
    ListView mListView;
    ListAdapter mAdapter;

    public LocationShipWhList(Activity activity, List<ShipWhListModel.Item> list, int title, Handler handler){
        mActivity = activity;
        mWhModel = list;
        mHandler = handler;
    ...
    private void showPopUpDialog(Activity activity, int title){
        ...
        for (ShipWhListModel.Item item : mWhModel)
            list.add(item.getWh_code());
    ...
    class ListAdapter extends BaseAdapter {
        ...
        @Override
        public ShipWhListModel.Item getItem(int position) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {
                ...
                v = mInflater.inflate(R.layout.cell_pop_wh_location, null);
                v.setTag(holder);
            ...
            final ShipWhListModel.Item item = mWhModel.get(position);
